...
public class JenkinsLoginDigest extends ObjectDigestImpl {
   ...
   static final String INVALID_CREDENTIAL_FORMAT = "Invalid credentials provided. Must not be empty.";
   ...
   /**
    * Method to attach the {@link JenkinsLoginPrompt} as the {@link Source} for the {@link ObjectDigest}.
    * @param source the {@link JenkinsLogin} source.
    */
   void attachSource( JenkinsLoginPrompt source ) {
   ...
   void validationError() {
      resetLoginProgress();
      log( Categories.error(), Messages.simpleMessage( INVALID_CREDENTIAL_FORMAT ) );
   }//End Method
