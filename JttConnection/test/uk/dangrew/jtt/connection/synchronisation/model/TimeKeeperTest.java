 ...
 * ----------------------------------------
 */
package uk.dangrew.jtt.connection.synchronisation.model;
...
public class TimeKeeperTest {
   ...
   @Test public void shouldShutdown(){
      systemUnderTest.shutdown();
      verify( timer ).cancel();
   }//End Method
   
   @Test public void shouldDetermineWhetherRunning(){
      assertThat( systemUnderTest.hasTimer(), is( true ) );
      systemUnderTest.shutdown();
      assertThat( systemUnderTest.hasTimer(), is( false ) );
   }//End Method
}//End Class
